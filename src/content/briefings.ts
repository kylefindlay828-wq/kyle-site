...
export const briefings: Briefing[] = [
  {
    ...
    pdf: '/src/assets/briefings/gtm-radar-2026-w14.pdf',
  },
  {
    week: 15,
    year: 2026,
    ...
    pdf: '/src/assets/briefings/gtm-radar-2026-w15.pdf',
  },
  {
    week: 16,
    year: 2026,
    ...
    pdf: '/src/assets/briefings/gtm-radar-2026-w16.pdf',
  },
  // Week 17 added post-rescan on 2026-04-27:
  // {
  //   week: 17, year: 2026, dateRange: 'Apr 20 – Apr 26',
  //   summary: '...', pdf: '/src/assets/briefings/gtm-radar-2026-w17.pdf',
  // },
];
...
export const memo = {
  ...
  pdf: '/src/assets/briefings/gtm-radar-memo.pdf',
};
